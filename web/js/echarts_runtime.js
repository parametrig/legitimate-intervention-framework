/* Read chart colors from CSS design tokens, fallback to hardcoded defaults */
function _css(v, fb) {
    try { return getComputedStyle(document.documentElement).getPropertyValue(v).trim() || fb; }
    catch { return fb; }
}
